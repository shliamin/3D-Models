...
export function updateModel() {
    ...
    let arc1 = perfectArc(vertices[0][0], vertices[3][0], height);
    let arc2 = perfectArc(vertices[1][0], vertices[2][0], height);
    let arc3 = perfectArc(vertices[0][0], vertices[3][0], height);
    let arc4 = perfectArc(vertices[2][0], vertices[1][0], height);
